          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-4 lg:pt-4">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="#" aria-label="Website" className="flex size-9 items-center justify-center rounded-full border border-white/20 bg-white/10 transition-colors hover:bg-white/20">
