          ...
          <div className="flex flex-col gap-8 sm:grid sm:grid-cols-2 md:grid-cols-4 lg:pt-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-3">
                {/* YouTube */}
                <Link href="/" aria-label="YouTube" className="flex size-9 items-center justify-center rounded-full border border-white/20 bg-white/10 transition-colors hover:bg-white/20">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/experienceattend/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex size-9 items-center justify-center rounded-full border border-white/20 bg-white/10 transition-colors hover:bg-white/20">
                  <svg className="size-4 text-white fill-current" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <Link href="/" aria-label="LinkedIn" className="flex size-9 items-center justify-center rounded-full border border-white/20 bg-white/10 transition-colors hover:bg-white/20">
                ...
                {/* X / Twitter */}
                <Link href="/" aria-label="X" className="flex size-9 items-center justify-center rounded-full border border-white/20 bg-white/10 transition-colors hover:bg-white/20">
                  <svg className="size-3.5 text-white fill-current" viewBox="0 0 24 24">
