      ...
      <div className="relative z-10 mx-auto w-full px-6 py-16 lg:px-8 xl:py-24">
        <div className="grid gap-16 lg:grid-cols-[1.2fr_1.5fr] xl:grid-cols-[1fr_1.5fr] lg:gap-24">
          ...
          <div className="flex flex-col">
            <Link href="/" className="mb-10 inline-block text-4xl font-bold tracking-tight text-white lg:text-[40px]">
              Attend
            </Link>
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-4 lg:pt-4">
            {/* Quick Links */}
            <div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-5 text-[13px] text-white/90">
                ...
                <li>0800MERISTEM</li>
                <li>
                  <div className="mb-1 text-[11px] font-semibold tracking-wider text-white/50 uppercase mt-2">EMAIL ADDRESS</div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="#" className="flex size-9 items-center justify-center rounded-full bg-white/10 transition-colors hover:bg-white/20">
        ...
        {/* Bottom Bar */}
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-[12px] text-white/50 md:flex-row">
          <p>© 2026 Meristem Securities Limited. All rights reserved.</p>
