          ...
          <div className="flex flex-col gap-8 sm:grid sm:grid-cols-2 md:grid-cols-4 lg:pt-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-3">
                {/* YouTube */}
                <a href="https://www.youtube.com/@experienceattendng" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className={socialIconClassName}>
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/experienceattend/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={socialIconClassName}>
                  <svg className="size-4 text-white fill-current" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/experienceattend/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className={socialIconClassName}>
                ...
                {/* X / Twitter */}
                <a href="https://x.com/Attend_NG" target="_blank" rel="noopener noreferrer" aria-label="X" className={socialIconClassName}>
                  <svg className="size-3.5 text-white fill-current" viewBox="0 0 24 24">
