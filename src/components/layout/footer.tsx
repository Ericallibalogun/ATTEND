          ...
          <div className="flex flex-col gap-8 sm:grid sm:grid-cols-2 md:grid-cols-4 lg:pt-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className={socialIconClassName}>
                ...
                {/* X / Twitter */}
                <a href="https://www.x.com" target="_blank" rel="noopener noreferrer" aria-label="X" className={socialIconClassName}>
                  <svg className="size-3.5 text-white fill-current" viewBox="0 0 24 24">
