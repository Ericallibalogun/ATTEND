...
export function InnovationSprint() {
  return (
    <section className="bg-[#F4F9F6] py-10 lg:py-14 text-zinc-900">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          {sprintCards.map((card, idx) => (
            ...
            >
              <div>
                {/* Green Spark Icon */}
                <div className="mb-8 flex size-10 items-center justify-center rounded-none bg-[#E2EEE7] text-primary">
